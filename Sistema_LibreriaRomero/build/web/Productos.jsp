...
<html>
    ...
    <form class="form-inline my-2 my-lg-0" action="Controlador" method="post">
            ...
            <div class="row justify-content-center">
                <div class="col-sm-8"> 
                    <form>
                     <%
                        ResultSet rs = (ResultSet) request.getSession().getAttribute("ListarProducto");
                        if (rs != null) {
                    %>
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><%= rs.getString("PrecioCompra")%></td>
                           ...
                           <td><%= rs.getString("Estado")%></td>
                            ...
                            <td>
                                <a class="btn btn-warning" href="Controlador?accion=EditarProducto&IdProducto=<%= rs.getInt("IdProducto")%>&NombreProducto=<%= rs.getString("NombreProducto")%>&IdCategoria=<%= rs.getInt("IdCategoria")%>&PrecioCompra=<%= rs.getString("PrecioCompra")%>&PrecioVenta=<%= rs.getString("PrecioVenta")%>&Cantidad=<%= rs.getString("Cantidad")%>&Estado=<%= rs.getString("Estado")%>"> Editar </a>
                               <a id="deleteUser" class="btn btn-danger" onclick="Confirmar(<%=rs.getInt("IdProducto")%>);" >Eliminar </a>
                            </td>
                        </tr>
                        <%
                            }
  ...
  if (result.isConfirmed) {
    ...
    window.location.href ="Controlador?accion=EliminarProducto&IdProducto="+IdProducto+"";
