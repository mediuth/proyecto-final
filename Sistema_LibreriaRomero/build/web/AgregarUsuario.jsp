                ...
                <div class="col-sm-8"> 
                    ...
                    <form action="Controlador">
                        <div class="form-group"> 
                            ...
                            <input id="user" name="NombreCompleto" type="text" class="form-control" placeholder="ingrese su nombre completo"> 
                        </div>
                        <div class="form-group"> 
                            <label for="pass" class="label">Usuario</label> 
                            <input id="pass" name="UserName" type="text" class="form-control" data-type="text" placeholder="ingrese su usuario"> 
                        </div>
                        <div class="form-group"> 
                            <label for="pass" class="label">Contraseña</label> 
                            <input id="pass" name="Pass" type="password" class="form-control" data-type="password" placeholder="ingrese su contraseña"> 
                        </div>
                        <div class="form-group">  
                        ...
                        <select class="form-control" id="cboRol" name="cboRol">
                                ...
                                <%
                                    if (rs != null) {
                                        while (rs.next()) {
                                %>
                                <option> <%= rs.getString("IdRol") + "-" + rs.getString("NombreRol")%> </option>
                                <%        }
                                    }
                                %>
                        </select>
                        ...
                        <div class="form-group"> 
                            ...
                            <input id="pass" name="Email" type="text" class="form-control" placeholder="Ingrese su Email"> 
                        </div>
                        <button type="submit" class="btn btn-primary" value="Agregar" name="accion">Crear Usuario</button>
                    </form>
