                ...
                <div class="col-sm-8"> 
                    ...
                    <form action="Controlador">
                        <div class="form-group">
                                ...
                                <input type="text" name="IdProducto" class="form-control" value="<%= IdProducto %>" readonly>
                            </div>
                        <div class="form-group"> 
                            <label for="user" class="label">Nombre Producto</label> 
                            <input id="user" name="NombreProducto" type="text" class="form-control" value="<%= NombreProducto %>"> 
                        </div>
                        <div class="form-group">  
                            <label for="pass" class="label">Seleecione Categoria</label> 
                                    ...
                                    if (rs != null) {
                                        while (rs.next()) {
                                            if (rs.getString("IdCategoria").equals(IdCategoria) ) {
                                                %>
                                                <option selected value="<%= rs.getString("IdCategoria")%>" ><%= rs.getString("NombreCategoria")%> </option>
                                                <%
                                            }else{
                                %>
                        ...
                        <div class="form-group"> 
                            ...
                            <input id="pass" name="PrecioCompra" type="text" class="form-control" value="<%= PrecioCompra %>"> 
                        </div>
                        <div class="form-group"> 
                            <label for="pass" class="label">Precio de Venta</label> 
                            <input id="pass" name="PrecioVenta" type="text" class="form-control" value="<%= PrecioVenta %>"> 
                        </div>
