<%-- 
    Document   : Ventas
    Created on : 11-14-2021, 08:02:06 PM
    Author     : Balmore
--%>
        ...
        <div class="row justify-content-center">
            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <blockquote class="blockquote text-center">
                                <p class="mb-0">PRODUCTOS DISPONIBLES</p>
                                         ...
                                         <%
                                         ResultSet rs = (ResultSet) request.getSession().getAttribute("ListarProductoVenta");
                                         if (rs != null) {
                                              %>   
                                             <table class="table">
                        ...
                        <tr>
                            ...
                            <td><%= rs.getDouble("PrecioVenta")%></td>
                            <td><%= rs.getInt("Cantidad")%></td>
                           
                          
                           
                            <td>
                                <a href="Controlador?accion=SeleccionarProducto&IdProducto=<%= rs.getInt("IdProducto")%>&NombreProducto=<%= rs.getString("NombreProducto")%>&NombreCategoria=<%= rs.getString("NombreCategoria")%>&PrecioVenta=<%= rs.getDouble("PrecioVenta")%>&Cantidad=<%= rs.getInt("Cantidad")%>" class="btn btn-outline-info"><i class="fas fa-cart-plus"></i> Seleccionar Producto</a>
                            </td>
                        </tr>
                        <%
                            }
