    ...
    <form class="form-inline my-2 my-lg-0" action="Controlador" method="post">
        ...
        <div class="col-md-4 mx-auto border border-primary" style="padding: 20px; border-radius: 15px;">
            <form class="form-control" action="Controlador" method="get">
                ...
                <input type="text" name="txtCate" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="Ingrese la categoria...">
                
                <label class="sr-only" for="inlineFormInputGroupUsername2">Descripción</label>
                <div class="input-group mb-2 mr-sm-2">
                    <input type="text" name="txtDescrip" class="form-control" id="inlineFormInputGroupUsername2" placeholder="Ingrese la descripción...">
                </div>

                <button type="submit" value="InsertarCate" name="accion" class="btn btn-primary mb-2">Registrar</button>
            </form>
        </div>
        <br>
        <hr>
