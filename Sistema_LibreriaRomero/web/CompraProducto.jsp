  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="Controlador" method="post">
        ...
        <%
            ...
            String nom = (String) request.getAttribute("NombreProducto");
            String prec = (String) request.getAttribute("PrecioCompra");
        ...
        <div class="col-md-4 mx-auto border border-primary " style="padding: 20px; border-radius: 15px;">
            <form class="" action="Controlador" method="get">
                <div class="form-inline" >
                    <label class="sr-only" for="inlineFormInputName2">Código</label> &nbsp;
                    <input type="text" name="txtCodProd" class="form-control mb-2 mr-sm-2"  id="inlineFormInputName2"  value="<%= id%>" readonly="true">

                    <label class="sr-only" for="inlineFormInputName2">Nombre</label>&nbsp;
                    <input type="text" name="txtProd" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" value="<%= nom%>" readonly="true">
                </div> 
                <label class="" for="inlineFormInputGroupUsername2">Precio de compra</label>
                <div class="input-group mb-2 mr-sm-2">
                    $<input type="text" name="txtPrecio" class="form-control" id="inlineFormInputGroupUsername2" value="<%= prec%>" readonly="true">
                </div>

                <label class="" for="inlineFormInputName2">Unidades en Stock</label> &nbsp;
                <div class="input-group mb-2 mr-sm-2">
                    <input type="text" name="txtCantidad" class="form-control" id="inlineFormInputGroupUsername2" value="<%= cant%>" readonly="true">
                </div>
                <hr>
                <label class="" for="inlineFormInputName2">Cantidad a comprar</label>&nbsp;
                <input type="number" name="txtCantCompra" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="Ingrese la cantidad que comprara...">
                <br>
                <button type="submit" value="AdquirirProducto" name="accion" class="btn btn-primary mb-2">Comprar</button>
            </form>
        </div>
    </body>
