...
<html>
    ...
    <body style="background-color: #c8c8c8">
        ...
        <%
            ...
            ResultSet rs = (ResultSet) request.getSession().getAttribute("Roles");
                ...
                <div class="col-sm-8"> 
                    ...
                    <form action="Controlador">
                        <div class="form-group">
                                ...
                                <input type="text" name="IdUsuario" class="form-control" value="<%= IdUsuario %>" readonly>
                            </div>
                        <div class="form-group"> 
                            <label for="user" class="label">Nombre Completo</label> 
                            <input id="user" name="NombreCompleto" type="text" class="form-control" value="<%= NombreCompleto %>"> 
                        </div>
                        <div class="form-group"> 
                            <label for="pass" class="label">Usuario</label> 
                            <input id="pass" name="UserName" type="text" class="form-control" data-type="text" value="<%= UserName %>"> 
                        </div>
                        <div class="form-group"> 
                            <label for="pass" class="label">Contraseña</label> 
                            <input id="pass" name="Pass" type="password" class="form-control" data-type="password" value="<%= Pass %>"> 
                        </div>
                        <div class="form-group">  
                            <label for="pass" class="label">Seleecione Rol</label> 
                        <select class="form-control" id="cboRol" name="cboRol">
                            <%
                                    if (rs != null) {
                                        while (rs.next()) {
                                            if (rs.getString("IdRol").equals(IdRol) ) {
                                                %>
                                                <option selected value="<%= rs.getString("IdRol")%>" ><%= rs.getString("NombreRol")%> </option>
                                                <%
                                            }else{
                                %>
                                <option value="<%= rs.getString("IdRol")%>" ><%= rs.getString("NombreRol")%> </option>
                        ...
                        <div class="form-group"> 
                            ...
                            <input id="pass" name="Email" type="text" class="form-control" value="<%= Email %>"> 
                        </div>
                        
                        <div class="form-group">  
                            <label for="pass" class="label">Seleecione Estado</label> 
                        <select class="form-control" id="cboEstado" name="cboEstado">
                            <%
                             if (Estado.equals("1")) {
                               ...
                               <button type="submit" class="btn btn-primary" value="GuardarCambio" name="accion">Modificar Usuario</button>
                    </form>
